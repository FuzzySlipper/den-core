        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            builder.ConfigureAppConfiguration((_, config) =>
            {
                config.AddInMemoryCollection(new Dictionary<string, string?>
                {
                    ...
                    ["llm-model"] = "fake",
                    ["DenCore:PiSessionHost:ComposeFile"] = "/opt/pi-docker/compose.yaml",
                    ["DenCore:PiSessionHost:DevDir"] = "/srv/dev",
                    ["DenCore:PiSessionHost:PiStateRootDir"] = "/srv/pi-state",
                    ["DenCore:PiSessionHost:Image"] = "pi-sandbox:test",
                    ["DenCore:PiSessionHost:PiVersion"] = "0.71.0",
                    ["DenCore:PiSessionHost:NodeVersion"] = "22",
                    ["DenCore:PiSessionHost:GitConfigPath"] = "/home/patch/.gitconfig",
                    ["DenCore:PiSessionHost:SshDir"] = "/home/patch/.ssh",
                    ["DenCore:PiSessionHost:GhConfigDir"] = "/home/patch/.config/gh",
                    ["DenCore:PiSessionHost:DockerHost"] = "unix:///run/den-mcp/docker-rt/docker.sock",
                    ["DenCore:PiSessionHost:TmuxShellCommand:0"] = "/bin/sh",
                    ["DenCore:PiSessionHost:TmuxShellCommand:1"] = "-i",
                    ["DenCore:PiSessionHost:RequiredPiStatePaths:0"] = "agent/settings.json",
                });
            });
        }
